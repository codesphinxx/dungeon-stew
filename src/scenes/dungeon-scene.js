...
export default class DungeonScene extends Phaser.Scene 
{
  ...
  create() 
  {
    ...
    let playerRoom = startRoom;
    let px = map.tileToWorldX(playerRoom.centerX);
    let py = map.tileToWorldY(playerRoom.centerY);
    this.player = Creator.createPlayer(this, null, px, py, 'player', 'Hero');
